...
<?php
  ...
  include('AddStudentFunction.php');
...
<body style="background: fixed;  background-position: center; background-size: cover;  background-repeat: no-repeat; background-image: url('../../images/home.jpg');">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto navbar-spacing mr-3" >
          <li class="nav-item active pr-2" >
            <a class="nav-link text-light" href="AddStudent.php"><i class="fas fa-plus"></i> Add Student</a>
          </li>
  ...
  <div class="pt-5 mt-4 pt-4 d-flex justify-content-center" style="background:transparent;" >
    <h1 class="display-3 d-flex justify-content-center text-light">Add Student</h1>
  </div>
  ...
  <div class="pt-5 pb-5 mt-4 pt-4 d-flex justify-content-center form-inline " style="background:transparent;">
    <form class="pt-4 mt-4 form-inline " method="post" action="AddStudent.php">
            ...
            <div>
                ...
                <input type="submit" class="btn btn-secondary btn-lg btn-block ml-1 " name="add" value="Add">
            </div>
        </form>
  </div>
    <!-- /Add Student Form -->
