<!-- DeleteStudent Website -->
<?php
 
  include('../../../database/connection_to_db.php');
  include('DeleteStudentFunction.php');
...
<body style="background: fixed;  background-position: center; background-size: cover;  background-repeat: no-repeat; background-image: url('../../images/home.jpg');">
    ...
    <nav class="navbar fixed-top navbar-expand-md navbar-light" style="background-color: rgb(100, 113, 105)" >
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto navbar-spacing mr-3" >
          ...
          <li class="nav-item active pl-2" >
            <a class="nav-link text-light" href="DeleteStudent.php"><i class="fas fa-user-times"></i> Delete Student</a>
          </li>
  ...
  <div class="pt-5 mt-4 pt-4 d-flex justify-content-center " style="background:transparent;">
    <h1 class="display-3 d-flex justify-content-center text-light">Delete Student</h1>
  </div>
  <div>
    <h5 class="d-flex justify-content-center text-light">Type the student's id you want to delete</h5>
  </div>

  
  <div class="pt-5 pb-5 mt-4 pt-4 d-flex justify-content-center " style="background:transparent;">
    <form action="DeleteStudent.php" class="pt-4 mt-4" method="post">
            ...
            <div>
                ...
                <input type="submit"  class="btn btn-secondary btn-lg btn-block" name="delete" value="Delete">
            </div>
        </form>
  </div>
    <!-- /Delete Student Form -->
